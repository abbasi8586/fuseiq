        ...
        <GlassCard className="p-8">
          <div className="text-center mb-8">
            <motion.div
              ...
              className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-[#00D4FF] to-[#B829DD] mb-4"
            >
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  minLength={6}
                  className="glass-input text-white placeholder:text-[#4A5068] pr-10"
                />
                <button
                  type="button"
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#161925] px-2 text-[#6B7290]">
                Or continue with
              </span>
            </div>
          </div>
          ...
          <p className="text-center mt-6 text-sm text-[#6B7290]">
